...
PRODUCT_COPY_FILES += \
    ...
    frameworks/av/media/libstagefright/ESDS.cpp:$(TARGET_COPY_OUT_VENDOR)/etc/ESDS.cpp \
    frameworks/av/media/libstagefright/CameraSource.cpp:$(TARGET_COPY_OUT_VENDOR)/etc/CameraSource.cpp \
